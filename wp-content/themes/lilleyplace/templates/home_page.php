			...
			<div class="slider-container mar-t-60">
				...
				?>
					...
					<figure style="width:<?php echo $front_page_image_resized; ?>px;">
						<img data-lazy="<?php echo $front_page_image['url']; ?>" width="<?php echo $front_page_image['width']; ?>" height="<?php echo $front_page_image['height']; ?>" alt="<?php echo $front_page_image['alt'] ?>" title="<?php echo $front_page_image['alt'] ?>">
					</figure>
			 		<?php endif; ?>
				<?php endwhile; ?>
				</div>
