...
function lilleyplace_sidebar_widgets() {
   ...
   register_sidebar(array(
     ...
     'description' => __( 'Drag widgets to this sidebar container.', 'lilleyplace' ),
     'before_widget' => '<article class="tt-contentbox">',
...
<ul class="social-icons">
  ...
  ?>
  <li>
    <a href="<?php echo $networks[$network]; ?>" class="<?php echo strtolower($network); ?>" target="_blank" title="<?php echo $network; ?>">
      <svg class="icon icon-<?php echo strtolower($network); ?>">
        <use xlink:href="#icon-<?php echo strtolower($network);  ?>"></use>
      </svg>
    </a>
  </li>
<?php
...
?>
  <li>
    <a href="<?php bloginfo('rss2_url'); ?>" target="_blank" class="rss" title="RSS">
...
?>
  <li>
    <a href="<?php echo $networks['RSS']; ?>" target="_blank" class="rss" title="RSS">
      <svg class="icon icon-feed">
        <use xlink:href="#icon-feed"></use>
      </svg>
    </a>
...
<p style="color:#999;">
  <em>
    <?php _e('Enter the full URL to each of your social media accounts. Simply leave the field blank if you wish not to display that social media service.', 'lilleyplace'); ?>
  </em>
</p>
<p>
...
<p>
  <label for="<?php echo $this->get_field_id('title_link'); ?>"><?php _e('Title link:', 'lilleyplace'); ?></label>     
	<?php
...
<p>
  <label for="<?php echo $this->get_field_id('rss'); ?>"><?php _e('RSS URL: (leave empty for default feed)', 'lilleyplace'); ?></label>
...
<p>
  <label for="<?php echo $this->get_field_id('twitter'); ?>"><?php _e('Twitter URL:', 'lilleyplace'); ?></label>
  <input class="widefat" id="<?php echo $this->get_field_id('twitter'); ?>" name="<?php echo $this->get_field_name('twitter'); ?>" type="text" value="<?php echo esc_attr($twitter); ?>">
</p>
<p>
  <label for="<?php echo $this->get_field_id('facebook'); ?>"><?php _e('Facebook URL:', 'lilleyplace'); ?></label>
  <input class="widefat" id="<?php echo $this->get_field_id('facebook'); ?>" name="<?php echo $this->get_field_name('facebook'); ?>" type="text" value="<?php echo esc_attr($facebook); ?>">
</p>
<p>
  <label for="<?php echo $this->get_field_id('instagram'); ?>"><?php _e('Instagram URL:', 'lilleyplace'); ?></label>
  <input class="widefat" id="<?php echo $this->get_field_id('instagram'); ?>" name="<?php echo $this->get_field_name('instagram'); ?>" type="text" value="<?php echo esc_attr($instagram); ?>">
</p>
<p>
  <label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('Email Address:', 'lilleyplace'); ?></label>
  <input class="widefat" id="<?php echo $this->get_field_id('email'); ?>" name="<?php echo $this->get_field_name('email'); ?>" type="text" value="<?php echo esc_attr($email); ?>">
</p>
<p>
  <label for="<?php echo $this->get_field_id('flickr'); ?>"><?php _e('Flickr URL:', 'lilleyplace'); ?></label>
...
<p>
  <label for="<?php echo $this->get_field_id('youtube'); ?>"><?php _e('Youtube URL:', 'lilleyplace'); ?></label>
  <input class="widefat" id="<?php echo $this->get_field_id('youtube'); ?>" name="<?php echo $this->get_field_name('youtube'); ?>" type="text" value="<?php echo esc_attr($youtube); ?>">
</p>
<p>
  <label for="<?php echo $this->get_field_id('linkedin'); ?>"><?php _e('LinkedIn URL:', 'lilleyplace'); ?></label>
  <input class="widefat" id="<?php echo $this->get_field_id('linkedin'); ?>" name="<?php echo $this->get_field_name('linkedin'); ?>" type="text" value="<?php echo esc_attr($linkedin); ?>">
</p>
<p>
  <label for="<?php echo $this->get_field_id('foursquare'); ?>"><?php _e('FourSquare URL:', 'lilleyplace'); ?></label>
...
<p>
  <label for="<?php echo $this->get_field_id('delicious'); ?>"><?php _e('Delicious URL:', 'lilleyplace'); ?></label>
...
<p>
  <label for="<?php echo $this->get_field_id('digg'); ?>"><?php _e('Digg URL:', 'lilleyplace'); ?></label>
...
<p>
  <label for="<?php echo $this->get_field_id('google-plus'); ?>"><?php _e('Google + URL:', 'lilleyplace'); ?></label>
  <input class="widefat" id="<?php echo $this->get_field_id('google-plus'); ?>" name="<?php echo $this->get_field_name('google-plus'); ?>" type="text" value="<?php echo esc_attr($google_plus); ?>">
</p>
<?php
    }
  }
...
<div id="google-maps-modal" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
  ...
  <p>
    <label for="<?php echo $this->get_field_id('text'); ?>"><?php _e('Zoom Level:', 'lilleyplace'); ?>
      <select class='widefat' id="<?php echo $this->get_field_id('zoom_level'); ?>" name="<?php echo $this->get_field_name('zoom_level'); ?>" type="text">
...
<ul class="vcard" itemscope itemtype="http://schema.org/Organization">
  ...
  ?>
    ...
    <!-- Address -->
    <p>
      <label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Street Address:', 'lilleyplace'); ?></label>
    ...
    <!-- City, State, Zip -->
    <p>
      <label for="<?php echo $this->get_field_id('city_state'); ?>"><?php _e('City, State, Zipcode:', 'lilleyplace'); ?></label>
      <input type="text" class="widefat" id="<?php echo $this->get_field_id('city_state'); ?>" name="<?php echo $this->get_field_name('city_state'); ?>" value="<?php echo $instance['city_state']; ?>">
    </p>
    <!-- Phone -->
    <p>
      <label for="<?php echo $this->get_field_id('phone'); ?>"><?php _e('Phone:', 'lilleyplace'); ?></label>
    ...
    <!-- Fax -->
    <p>
      <label for="<?php echo $this->get_field_id('fax'); ?>"><?php _e('Fax:', 'lilleyplace'); ?></label>
    ...
    <!-- Email -->
    <p>
      <label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('Email:', 'lilleyplace'); ?></label>
