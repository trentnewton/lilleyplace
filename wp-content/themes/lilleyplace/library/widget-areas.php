...
?>
		<ul class="business-hours">
			<li><span class="day"><?php _e('Monday:','lilleyplace');?></span><span class="hours"><?php
      echo $mon;
?></span></li>
			<li><span class="day"><?php _e('Tuesday:','lilleyplace');?></span><span class="hours"><?php
      echo $tues;
?></span></li>
			<li><span class="day"><?php _e('Wednesday:','lilleyplace');?></span><span class="hours"><?php
      echo $wed;
?></span></li>
			<li><span class="day"><?php _e('Thursday:','lilleyplace');?></span><span class="hours"><?php
      echo $thurs;
?></span></li>
			<li><span class="day"><?php _e('Friday:','lilleyplace');?></span><span class="hours"><?php
      echo $fri;
?></span></li>
			<li><span class="day"><?php _e('Saturday:','lilleyplace');?></span><span class="hours"><?php
      echo $sat;
?></span></li>
			<li><span class="day"><?php _e('Sunday:','lilleyplace');?></span><span class="hours"><?php
      echo $sun;
?></span></li>
		</ul>
        <?php
     ...
     <p>
      <label for="<?php echo $this->get_field_id('text'); ?>"><?php _e('Zoom Level:', 'lilleyplace'); ?>
        <select class='widefat' id="<?php echo $this->get_field_id('zoom_level'); ?>"
	          ...
	          <option value='0'<?php echo ($zoom=='0')?'selected':''; ?>>
	            0 - entire world
	          </option>
	          <option value='1'<?php echo ($zoom=='1')?'selected':''; ?>>
	            1
	          </option>
	          <option value='2'<?php echo ($zoom=='2')?'selected':''; ?>>
	            2
	          </option>
	          <option value='3'<?php echo ($zoom=='3')?'selected':''; ?>>
	            3
	          </option>
	          <option value='4'<?php echo ($zoom=='4')?'selected':''; ?>>
	            4
	          </option>
	          <option value='5'<?php echo ($zoom=='5')?'selected':''; ?>>
	            5
	          </option>
	          <option value='6'<?php echo ($zoom=='6')?'selected':''; ?>>
	           6
	          </option>
	          <option value='7'<?php echo ($zoom=='7')?'selected':''; ?>>
	            7
	          </option>
	          <option value='8'<?php echo ($zoom=='8')?'selected':''; ?>>
	            8
	          </option>
	          <option value='9'<?php echo ($zoom=='9')?'selected':''; ?>>
	            9
	          </option>
	          <option value='10'<?php echo ($zoom=='10')?'selected':''; ?>>
	            10
	          </option>
	          <option value='11'<?php echo ($zoom=='11')?'selected':''; ?>>
	            11
	          </option>
	          <option value='12'<?php echo ($zoom=='12')?'selected':''; ?>>
	            12
	          </option>
	          <option value='13'<?php echo ($zoom=='13')?'selected':''; ?>>
	            13
	          </option>
	          <option value='14'<?php echo ($zoom=='14')?'selected':''; ?>>
	            14
	          </option>
	          <option value='15'<?php echo ($zoom=='15')?'selected':''; ?>>
	            15
	          </option>
	          <option value='16'<?php echo ($zoom=='16')?'selected':''; ?>>
	            16
	          </option>
	          <option value='17'<?php echo ($zoom=='17')?'selected':''; ?>>
	            17
	          </option>
	          <option value='18'<?php echo ($zoom=='18')?'selected':''; ?>>
	            18
	          </option>
	          <option value='19'<?php echo ($zoom=='19')?'selected':''; ?>>
	            19
	          </option>
	          <option value='20'<?php echo ($zoom=='20')?'selected':''; ?>>
	            20
	          </option>
	          <option value='21'<?php echo ($zoom=='21')?'selected':''; ?>>
	            21
	          </option>
        	</select>
      </label>
