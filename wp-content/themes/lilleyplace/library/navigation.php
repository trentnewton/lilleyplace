...
*/
if ( ! function_exists( 'lilleyplace_add_menuclass' ) ) {
	function lilleyplace_add_menuclass($ulclass) {
	    $find = array('/<a rel="button"/', '/<a title=".*?" rel="button"/');
	    $replace = array('<a rel="button" class="button"', '<a rel="button" class="button"');

	    return preg_replace( $find, $replace, $ulclass, 1 );
	}
	add_filter( 'wp_nav_menu','lilleyplace_add_menuclass' );
}
 ...
 */
function lilleyplace_breadcrumb($showhome = true, $separatorclass = false) {
