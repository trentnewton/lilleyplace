...
jQuery('document').ready(function($){
  ...
  commentform.submit(function(){
    ...
    statusdiv.html('<img class="ajax-loader" src="http://lilleyplace/wp-content/themes/lilleyplace/assets/img/images/preloader.gif" alt="Processing...">');
      ...
      $.ajax({
        ...
        success: function(data, textStatus)
          ...
          if(data=="success")
            ...
            statusdiv.html('<div role="alert" style="display: block;" class="wpcf7-response-output wpcf7-mail-sent-ng">Please wait a while before posting your next comment</div>');
